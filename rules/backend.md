...
- VERY IMPORTANT: When introducing new method or function in golang please think if it is domain-related or generic. Domain-related methods should be struct-bound, while generic functions should be placed somewhere else (in util package or also bound to struct)
